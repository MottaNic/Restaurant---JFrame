...
public class notvegi {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Welcome to the non-vegetarian menu");
		lblNewLabel.setFont(new Font("Sylfaen", Font.PLAIN, 20));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setBounds(30, 11, 349, 27);
		...
		JRadioButton rdbtnNewRadioButton = new JRadioButton("Pato il pasto");
		...
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Cuy il pasto");
		...
		lblNewLabel_6.setBounds(100, 212, 123, 31);
